...
/*   Updated: 2026/01/30 06:05:34 by regillio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	if (!parse_argv(argc, argv, settings))
		return (0);
	philos = ft_calloc(settings->table->number_of_philos, sizeof(t_philo));
	settings->philo = philos;
	table->forks = ft_calloc(table->number_of_philos, sizeof(pthread_mutex_t));
